...
import { githubRepoDetail } from 'shared/utils/consts';

export default function RepoDetails(): JSX.Element {
  const repoData = githubRepoDetail;
  return (
    <>
          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-6 flex flex-col justify-center items-center">
            ...
            <div className="items-center w-3/4">
              ...
              <p className="italic text-purple-50 text-sm mt-8">
                *Credits to the owners for the vectors/icons used. These are picked from various sources from the
                internet. <br />
              ...
              <a href={repoData.html_url}>
                <Tilt className="Tilt">
                  <div className="bg-violet p-10 rounded-3xl shadow-violet-5xl">
                    ...
                    <p>
                      Last Updated :
                      <span className="italic font-light"> {new Date(repoData.updated_at).toDateString()}</span>
                    </p>
                  </div>
                </Tilt>
              </a>
